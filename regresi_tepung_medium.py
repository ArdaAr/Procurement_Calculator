...
model_tepung = pickle.load(open('regresi_tepung_medium.sav', 'rb'))
...
with container1:
    ...
    st.title('Prediksi harga penawaran Tepung Terigu Medium')
    ...
    if st.button('Predict harga penawaran Tepung Terigu Medium'):
